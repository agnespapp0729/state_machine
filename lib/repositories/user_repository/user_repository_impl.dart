...
class UserRepositoryImpl extends UserRepository {
  ...
  List<Map<String, dynamic>> getUsers() {
    List<Map<String,dynamic>> users = _userBox.keys.map(
      (key) {
  ...
  @override
  Future<List<Map<String, dynamic>>> createUser( Map<String, dynamic> newUser) async {
  ...
  @override
  Future<List<Map<String, dynamic>>> updateUser( int key, Map<String, dynamic> user) async {
