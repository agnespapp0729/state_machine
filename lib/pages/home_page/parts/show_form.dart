...
class  ShowFormEmbedder{
  ...
  ShowFormEmbedder({required this.bloc, required this.userKey, required this.actualUsers});
  ...
  void showForm(BuildContext context) {
    if (userKey != null) {
      final Map<String, dynamic> existingUser = actualUsers.firstWhere((element) => element['key'] == userKey);
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                if (userKey == null) {
                  bloc.add(CreateUserEvent({"name": _nameController.text,"age": _ageController.text}));
                }
  
                if (userKey != null) {
                  bloc.add(UpdateUserEvent(userKey!, {"name": _nameController.text,"age": _ageController.text}));
                }
